...
//}
//class DeviceManager(){
//    private var listDeviec = mutableListOf<Device>()
//    fun addDevice(device: Device){
//        listDeviec.add(device)
//    }
//
//    fun removeDeviceByID(id : String){
//        listDeviec.removeIf {it.id == id}
//    }
//
////    fun updateDeviceById(id : String, updated : Device){
////        val device = listDeviec.find {it.getId() == id}
////
////        if (device == null){
////            println("không tìm thấy id")
////        } else {
////            device.setInfo(updated.)
////        }
////    }
//
//    fun showInfo(){
...
//    home.showInfo()
//    if (camera is Camera){
////      kiểm tra camera kiểu dữ liệu gì
////        nếu là camera thì trả về true ,
//    }
//}
//
