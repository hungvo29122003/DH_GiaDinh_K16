<template>
    <main>  
         <div class="menu">
             ...
             <div class="menu-carousel">
                 ...
                 <div v-else-if="this.isFull == false">
 ...
 export default {
    ...
    mounted(){
        // lấy id từ url xuống ví dụ id trên url=2
        let id=this.$route.params.id
        // dò trong database đồi tượng nào có id = id của url
        this.product=items.find(item=>item.id==id)
    },
    methods:{
        addToCart(product){
            // kiểm tra hàng có trong giở hay chưa
